...
namespace Madingley
{
    ...
    public class Reproduction : IEcologicalProcessWithinGridCell
    {
        ...
        public void RunEcologicalProcess(GridCellCohortHandler gridCellCohorts, GridCellStockHandler gridCellStocks, 
            ...
            uint currentTimeStep, ProcessTracker processTracker, FunctionalGroupTracker functionalTracker, HighResFGTracker highResFGTracker, CohortTracker cohortTracker,
