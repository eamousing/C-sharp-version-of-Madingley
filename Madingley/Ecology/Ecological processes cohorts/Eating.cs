...
namespace Madingley
{
    ...
    public class Eating: IEcologicalProcessWithinGridCell
    {
        ...
        public void RunEcologicalProcess(GridCellCohortHandler gridCellCohorts, 
            ...
            uint currentTimestep, ProcessTracker trackProcesses, FunctionalGroupTracker functionalTracker, HighResFGTracker highResFGTracker, CohortTracker cohortTracker,
            ...
            switch (NutritionSource)
            {
                case "herbivore":
                    ...
                    Implementations["revised herbivory"].RunEating
                        ...
                        madingleyStockDefinitions, trackProcesses, functionalTracker, highResFGTracker, cohortTracker,
                ...
                case "carnivore":
                    ...
                    Implementations["revised predation"].RunEating
                        ...
                        madingleyCohortDefinitions, madingleyStockDefinitions, trackProcesses, functionalTracker, highResFGTracker, cohortTracker,
                        currentTimestep, specificLocations,outputDetail, initialisation);
